...
Decoding is provided by MoonAV1 through `codec_moonav1.mbt`. Existing PixelForge call forms remain available; AVIF encoding retains its separate browser adapter.
